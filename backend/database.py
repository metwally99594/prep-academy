...
EXAM_LOCATIONS = ["vienna", "innsbruck", "hamburg", "berlin", "munich", "bern", "zurich", "basel", "geneva", "andere"]
...
EXAM_TYPES = [
    ...
    {"id": "kp_deutschland", "name": "Kenntnisprüfung", "subtitle": "Kenntnisprüfung (Deutschland)", "location": "de", "country": "germany", "icon": "flag_de"},
    {"id": "kp_schweiz", "name": "Eidgenössische Prüfung", "subtitle": "Medizinalprüfung (Schweiz)", "location": "ch", "country": "switzerland", "icon": "flag_ch"},
]
