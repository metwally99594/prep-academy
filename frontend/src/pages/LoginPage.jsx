...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12" style={{ background: "linear-gradient(135deg, #080818 0%, #0c1229 50%, #080818 100%)" }}>
      <div className="w-full max-w-md">
        ...
        {/* Email/Password Form */}
        <form onSubmit={handleSubmit} className="rounded-2xl p-8 space-y-6 border border-[#c9a84c]/10" style={{ background: 'rgba(12, 18, 41, 0.8)', backdropFilter: 'blur(20px)' }}>
          ...
          <div className="text-center text-sm">
            ...
            <Link to="/register" className="text-[#c9a84c] hover:underline" data-testid="register-link">
              Registrieren
            </Link>
          </div>
        </form>
