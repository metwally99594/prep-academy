    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-12" data-testid="guest-quiz-select">
        <div className="text-center mb-10">
          <GraduationCap className="w-12 h-12 mx-auto mb-3" style={{ color: '#c9a84c' }} />
          <h1 className="text-3xl font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>
            Kostenlos <span style={{ color: '#c9a84c' }}>testen</span>
          </h1>
  ...
  if (stage === "done") {
    return (
      <div className="max-w-lg mx-auto px-4 py-12 text-center" data-testid="guest-quiz-done">
        <div className="text-6xl font-bold mb-2" style={{ color: '#c9a84c' }}>{percentage}%</div>
        ...
        <div className="flex gap-3 justify-center">
          <Button onClick={() => navigate("/register")} className="gap-2" style={{ background: 'linear-gradient(135deg, #c9a84c, #dbb85c)', color: '#06081a' }} data-testid="guest-register-btn">
    ...
    <div className="max-w-2xl mx-auto px-4 py-8" data-testid="guest-quiz-active">
      ...
      <div className="space-y-3">
        {(q.choices || []).map(c => {
          ...
          else if (!submitted && c.id === selectedChoice) style = "border-[#c9a84c]/50 bg-[#c9a84c]/5";
          return (
      ...
      {submitted && (
        <Button onClick={nextQuestion} className="w-full mt-4 gap-2" style={{ background: 'linear-gradient(135deg, #c9a84c, #dbb85c)', color: '#06081a' }} data-testid="guest-next-btn">
