...
function ImportQuestionsTab({ token, onImportComplete }) {
  ...
  "country": "austria"
            ...
            <div className="p-3 rounded-lg bg-muted/50">
              ...
              <p className="mt-1">Orte AT: <code className="text-primary">vienna</code> <code className="text-primary">sip4</code> <code className="text-primary">sip5</code> <code className="text-primary">innsbruck</code> <code className="text-primary">graz</code> <code className="text-primary">linz</code> <code className="text-primary">salzburg</code></p>
              ...
              <p className="mt-1">Datum (optional): <code className="text-primary">month</code> 1–12 · <code className="text-primary">day</code> 1–31 — zusätzlich zu <code className="text-primary">year</code></p>
            </div>
          </div>
        </details>
      </div>
